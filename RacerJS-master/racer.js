var game = (function(){
    ...
    var renderSplashFrame = function(){
        ...
        drawString("code, art: Abhik Lodh",{x: 55, y: 130});
    ...
    var renderGameFrame = function(){
        ...
        if(absoluteIndex >= roadParam.length-render.depthOfField-1){
            ...
            $(window).keydown(function(e){ if(e.keyCode == 84) {location.href="http://twitter.com/home?status="+escape("I've just raced through #bughattirace in "+currentTimeString+"!")}});
        }
