...
$(window).load(function() {
    ...
    $('#about').click(function() {
        $('#dialog').html('<div class="contents">Copyright 2014 <a href="http://bloggercls8e.com">Abhik Lodh</a>' +
        ...
        'also not for non-tech geeks which is available available on <a href="http://github.com/evanw/webgl-filter/">GitHub</a>.</div><div class="button ' +
